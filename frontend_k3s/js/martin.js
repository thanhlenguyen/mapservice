...
const STYLES = [
    { id: 'basic-style', name: 'Default',   url: 'http://map.172-17-65-26.nip.io/styles/martin/style.json', pitch: 0, zoom: 12, bearing: 0 },
    { id: 'sat-style',   name: 'Satellite', url: 'http://map.172-17-65-26.nip.io/styles/martin/style_sat.json', pitch: 0, zoom: 12, bearing: 0 },
    { id: '3d-style',    name: '3D',        url: 'http://map.172-17-65-26.nip.io/styles/martin/style_3d.json', pitch: 45, zoom: 14, bearing: 0 }
];
