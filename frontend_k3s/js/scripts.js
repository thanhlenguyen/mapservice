...
// --- All map styles  ---
const STYLES = [
    { id: 'basic-style', name: 'Default',   url: 'http://map.172-17-65-26.sslip.io/styles/martin/style.json',     pitch: 0,  zoom: 12, bearing: 0   },
    { id: 'sat-style',   name: 'Satellite', url: 'http://map.172-17-65-26.sslip.io/styles/martin/style_sat.json', pitch: 0,  zoom: 12, bearing: 0   },
    { id: '3d-style',    name: '3D',        url: 'http://map.172-17-65-26.sslip.io/styles/martin/style_3d.json',  pitch: 45, zoom: 14, bearing: 0   },
    { id: 'bdf-style',   name: 'BDF',       url: 'http://map.172-17-65-26.sslip.io/styles/martin/style_bdf.json', pitch: 60, zoom: 17, bearing: -20 }
];

// --- Backend API ---
const BACKEND_URL = 'http://api.172-17-65-26.sslip.io';
const API_ENDPOINTS = {
...
// --- Elasticsearch ---
const ES_URL = 'http://elasticsearch.172-17-65-26.sslip.io'; 
    ...
    class LayerSwitcher {
        onAdd(map) {
            ...
            STYLES.forEach(style => {
                ...
                btn.textContent = style.name === '3D' ? '3D' : style.name === 'BDF' ? 'BDF' : style.name.charAt(0); //style.name;
                btn.onclick = () => {
