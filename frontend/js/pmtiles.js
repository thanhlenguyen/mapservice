...
const STYLES = [
    { id: 'basic-style', name: 'Default',   url: 'http://localhost:3001/styles/pmtiles/style.json', pitch: 0, zoom: 12, bearing: 0 },
    { id: 'sat-style',   name: 'Satellite', url: 'http://localhost:3001/styles/pmtiles/style_sat.json', pitch: 0, zoom: 12, bearing: 0 },
    { id: '3d-style',    name: '3D',        url: 'http://localhost:3001/styles/pmtiles/style_3d.json', pitch: 45, zoom: 14, bearing: 0 }
];
